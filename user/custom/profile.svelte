...
<div
  class="relative rounded-xl w-auto p-4 my-4 overflow-hidden transition-shadow duration-300 shadow-xl gradeient-animation min-h-48 rounded-box bg-gradient-to-b from-primary to-secondary text-primary-content hover:shadow-2xl md:p-8">
  <div class="mb-4 avatar">
    <div class="w-16 h-16 border-2 border-white overflow-hidden rounded-full shadow-xl">
      <img
        class="transition-transform duration-1000 ease-in-out m-0"
